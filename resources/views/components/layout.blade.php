    ...
    <body>
        ...
        <style>
            * {
            ...
            .main-about__staff-container, .main-about__contacts-container  {
                display: flex;
                flex-direction: row;
            }
            ...
            .main-about__contacts-el-name {
                font-size: 22px;
            }
            .main-about__contacts-el-inf {
                color: #398ec6;
            }
            .main-about__contacts-el-inf span {
                color: #666666;
            }
