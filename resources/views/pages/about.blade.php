...
<div class="el main-about">
    ...
    <div class="main-about__staff-container">
        ...
        <div class="main-about__staff-el">
            <div class="main-about__staff-el-img" style="background-image: url('/storage/{{$el->avatar_root}}');"></div>
    ...
    <div class="main-about__contacts-container">
        ...
        <div class="main-about__contacts-el">
            ...
            <p class="main-about__contacts-el-inf"><span>Почта:</span> {{$el->email}}</p>
        </div>
        @endforeach
    </div>
    @endif
